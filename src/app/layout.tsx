...
export const metadata: Metadata = {
  ...
  description:
    "Software engineer building products, tools and open source — an AI agent for Discord, native Windows apps, a self-hosted image host, CLIs. Rust, TypeScript, Go and the web.",
  ...
  openGraph: {
    title: "Nirlep Gohil | Software Engineer",
    description: "Software engineer. Products, tools and open source — Rust, TypeScript, Go and the web.",
    type: "website",
    url: SITE.url,
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Nirlep Gohil — Software engineer" }],
  },
  twitter: {
