...
import { Code2, Database, Globe, Laptop, Rocket, Terminal } from "lucide-react";
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm border border-white/5">
              ...
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm border border-white/5">
                ...
                <p className="text-gray-300">
                  Python, Rust, Go, NodeJS, PostgreSQL, Docker
                </p>
              </div>
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm border border-white/5">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm border border-white/5">
                ...
                <p className="text-gray-300">
                  System Design, Open Source, Competitive Programming
                </p>
              </div>
            </motion.div>
          </div>
