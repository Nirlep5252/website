...
function SocialLink(props: { icon: React.ReactNode; link: string }) {
  return (
    <motion.div
      variants={variants}
      initial={"hidden"}
    ...
    >
      <Link
        href={props.link}
        target="_blank"
        className="p-5 rounded-full flex items-center justify-center hover-glassmorphism"
      >
        {props.icon}
      </Link>
    </motion.div>
    ...
    <div className="nirlep2-container overflow-x-hidden h-screen w-screen flex items-center justify-center flex-col">
      ...
      >
        <SocialLink
          ...
          link={"https://github.com/nirlep5252"}
        />
        <SocialLink
          icon={
            <svg
        ...
        <SocialLink
          ...
          link="https://www.linkedin.com/in/nirlep5252/"
        />
        <SocialLink
          icon={<Twitter className="w-8 h-8" />}
          link="https://twitter.com/nirlep_5252_"
        />
        <SocialLink
          icon={<MailIcon className="w-8 h-8" />}
          link="mailto:hello@nirlep.dev"
        />
      </motion.div>
    </div>
  );
