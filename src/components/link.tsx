...
export default function UwULink(props: LinkProps) {
  ...
  const e = (
    <>
      <span className="z-0 underline h-0.5 bg-white absolute -bottom-0.5 left-0 transition-all duration-200 ease-linear"></span>
      <span className="z-10 text">{props.text}</span>
    </>
  );
  return (
    <>
