...
export const projects: Project[] = [
  {
    title: "BondBot",
    description: "Discord AI agent for server management via natural language commands.",
  ...
  {
    title: "Brilliant++",
    description: "AI-powered education platform with personalized learning paths and interactive exercises.",
