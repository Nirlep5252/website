...
function Project(props: ProjectProps) {
  return (
    <div className="project relative bg-white bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-10 hover:border-gray-200 transition-all duration-200 border border-transparent rounded-lg p-4 h-44">
